...
export default function generateInspectionOFAssetReportAction(requestData) {
    ...
    return dispatch => {
        ...
        generateInspectionOfAssetReport(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(reportList,tostMsg) { return { type: userConstants.GENERATE_INSPECTION_OF_ASSET_REPORT_REQUEST,reportList,tostMsg} }
    function success(reportList,tostMsg) { return { type: userConstants.GENERATE_INSPECTION_OF_ASSET_REPORT_SUCCESS, reportList,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.GENERATE_INSPECTION_OF_ASSET_REPORT_FAILURE, error ,tostMsg } }
}
