...
export default function inspectionSearchListAction(urlParamerter,pageIndex,) {
    ...
    return dispatch => {
        ...
        inspectionSearchList(urlParamerter).then(response => {
            $('#pageLoading').hide();
    ...
    function request(inspectionList,tostMsg) { return { type: userConstants.INSPECTIONLIST_SEARCH_REQUEST,inspectionList,tostMsg} }
    function success(inspectionList,searchString,tostMsg) { return { type: userConstants.INSPECTIONLIST_SEARCH_SUCCESS,pageIndex, inspectionList ,searchString,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.INSPECTIONLIST_SEARCH_FAILURE, error,tostMsg } }
}