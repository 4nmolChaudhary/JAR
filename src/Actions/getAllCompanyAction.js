...
export default function getAllCompanyListAction() {
    ...
    function request(companyList,tostMsg) { return { type: userConstants.GETALLCOMPANY_REQUEST,companyList,tostMsg} }
    function success(companyList,tostMsg) { return { type: userConstants.GETALLCOMPANY_SUCCESS, companyList ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.GETALLCOMPANY_FAILURE, error,tostMsg } }
}