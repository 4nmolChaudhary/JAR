...
export default function updateEmailNotificationAction(urlParameters,status) {
    ...
    return dispatch => {
        ...
        updateEmailNotification(urlParameters).then(response => {
            $('#pageLoading').hide();
    ...
    function request(updateEmialNotification,tostMsg) { return { type: userConstants.UPDATE_EMAIL_NOTIFICATION_REQUEST,updateEmialNotification , tostMsg} }
    function success(updateEmialNotification,tostMsg) { return { type: userConstants.UPDATE_EMAIL_NOTIFICATION_SUCCESS, updateEmialNotification ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_EMAIL_NOTIFICATION_FAILURE, error ,tostMsg} }
}