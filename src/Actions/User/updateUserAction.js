...
export default function updateUserAction(requestData) {
    ...
    function request(updateUser,tostMsg) { return { type: userConstants.UPDATE_USER_REQUEST,updateUser,tostMsg} }
    function success(updateUser,tostMsg) { return { type: userConstants.UPDATE_USER_SUCCESS, updateUser,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_USER_FAILURE, error ,tostMsg} }
}