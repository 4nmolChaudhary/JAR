...
export default function updateUserProfileAction(requestData) {
    ...
    return dispatch => {
        ...
        updateUserProfile(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(updateUser,tostMsg) { return { type: userConstants.UPDATE_USER_PROFILE_REQUEST,updateUser,tostMsg} }
    function success(updateUser,tostMsg) { return { type: userConstants.UPDATE_USER_PROFILE_SUCCESS, updateUser ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_USER_PROFILE_FAILURE, error ,tostMsg} }
}