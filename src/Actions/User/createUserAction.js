...
export default function createUserAction(requestData) {
    ...
    function request(createUser,tostMsg) { return { type: userConstants.CREATE_USER_REQUEST,createUser,tostMsg} }
    function success(createUser,tostMsg) { return { type: userConstants.CREATE_USER_SUCCESS, createUser,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.CREATE_USER_FAILURE, error ,tostMsg} }
}