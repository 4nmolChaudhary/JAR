...
export default function updateUserStatusAction(requestData) {
    ...
    return dispatch => {
        ...
        updateUserStatus(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(updateUserStatus,tostMsg) { return { type: userConstants.UPDATE_USER_STATUS_REQUEST,updateUserStatus,tostMsg} }
    function success(updateUserStatus,tostMsg) { return { type: userConstants.UPDATE_USER_STATUS_SUCCESS, updateUserStatus ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_USER_STATUS_FAILURE, error ,tostMsg } }
}