...
export default function notificationListAction(urlPrameters,pageIndex) {
    ...
    return dispatch => {
        ...
        notificationList(urlPrameters).then(response => {
    ...
    function request(notificationList,tostMsg) { return { type: userConstants.NOTIFICATION_LIST_REQUEST,notificationList,tostMsg} }
    function success(notificationList,tostMsg) { return { type: userConstants.NOTIFICATION_LIST_SUCCESS,pageIndex, notificationList,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.NOTIFICATION_LIST_FAILURE, error ,tostMsg } }
}