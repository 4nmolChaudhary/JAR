...
export default function uploadInspectionFormAction(requestData) {
    ...
    return dispatch => {
        ...
        uploadInspectionForm(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(uploadInspection,tostMsg) { return { type: userConstants.UPLOAD_INSPECTIONFORMS_REQUEST,uploadInspection,tostMsg} }
    function success(uploadInspection,tostMsg) { return { type: userConstants.UPLOAD_INSPECTIONFORMS_SUCCESS, uploadInspection,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.UPLOAD_INSPECTIONFORMS_FAILURE, error ,tostMsg} }
}