...
export default function approveInspectionAction(requestData,searchString='',type) {
    ...
    return dispatch => {
        ...
        approveInspection(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(approveInspection,tostMsg) { return { type: userConstants.APPROVEINAPECTION_REQUEST,approveInspection,tostMsg} }
    function success(approveInspection,tostMsg) { return { type: userConstants.APPROVEINAPECTION_SUCCESS, approveInspection ,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.APPROVEINAPECTION_FAILURE, error ,tostMsg} }
}