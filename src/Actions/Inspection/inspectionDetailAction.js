...
export default function inspectionDetailAction(inspectionId,userId) {
    ...
    return dispatch => {
        ...
        inspectionDetail(inspectionId,userId).then(response => {
            $('#pageLoading').hide();
    ...
    function request(inspectionDetail,tostMsg) { return { type: userConstants.INSPECTIONDETAIL_REQUEST,inspectionDetail ,tostMsg} }
    function success(inspectionDetail,tostMsg) { return { type: userConstants.INSPECTIONDETAIL_SUCCESS, inspectionDetail ,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.INSPECTIONDETAIL_FAILURE, error ,tostMsg } }
}