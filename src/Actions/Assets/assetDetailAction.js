...
export default function assetDetailAction(requestData) {
    ...
    return dispatch => {
        ...
        assetDetail(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(assetDetail,tostMsg) { return { type: userConstants.ASSETDETAIL_REQUEST,assetDetail , tostMsg} }
    function success(assetDetail,tostMsg) { return { type: userConstants.ASSETDETAIL_SUCCESS, assetDetail , tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.ASSETDETAIL_FAILURE, error ,tostMsg} }
}