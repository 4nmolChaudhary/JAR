...
export default function updateAssetStatusAction(requestData) {
    ...
    return dispatch => {
        ...
        updateAssetStatus(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(updateAssetStatus,tostMsg) { return { type: userConstants.UPDATE_ASSET_STATUS_REQUEST,updateAssetStatus,tostMsg} }
    function success(updateAssetStatus,tostMsg) { return { type: userConstants.UPDATE_ASSET_STATUS_SUCCESS, updateAssetStatus ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_ASSET_STATUS_FAILURE, error ,tostMsg } }
}