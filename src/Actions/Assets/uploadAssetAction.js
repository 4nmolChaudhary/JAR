...
export default function uploadAssetAction(requestData) {
    ...
    return dispatch => {
        ...
        uploadAsset(requestData).then(response => {
    ...
    function request(uploadAsset,tostMsg) { return { type: userConstants.UPLOAD_ASSET_REQUEST,uploadAsset,tostMsg} }
    function success(uploadAsset,tostMsg) { return { type: userConstants.UPLOAD_ASSET_SUCCESS, uploadAsset ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.UPLOAD_ASSET_FAILURE, error ,tostMsg} }
}