...
export default function updateMeterHourAction(requestData) {
    ...
    return dispatch => {
        ...
        updateMeterHour(requestData).then(response => {
            $('#pageLoading').hide();
    ...
    function request(Updateddata,tostMsg) { return { type: userConstants.UPDATE_METER_HOUR_REQUEST,Updateddata,tostMsg} }
    function success(Updateddata,tostMsg) { return { type: userConstants.UPDATE_METER_HOUR_SUCCESS, Updateddata,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.UPDATE_METER_HOUR_FAILURE, error ,tostMsg} }
}