...
export default function dashboardListAction(userId) {
    ...
    return dispatch => {
        ...
        dashboardList(userId).then(response => {
    ...
    function request(dashboardList,tostMsg) { return { type: userConstants.DASHBOARDLIST_REQUEST,dashboardList,tostMsg} }
    function success(dashboardList,tostMsg) { return { type: userConstants.DASHBOARDLIST_SUCCESS, dashboardList,tostMsg } }
    function failure(error,tostMsg) { return { type: userConstants.DASHBOARDLIST_FAILURE, error ,tostMsg} }
}