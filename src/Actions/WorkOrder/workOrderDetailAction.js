...
export default function workOrderDetailAction(uuid,workOrderId) {
    ...
    return dispatch => {
        ...
        workOrderDetail(uuid,workOrderId).then(response => {
    ...
    function request(workOrderDetail,tostMsg) { return { type: userConstants.WORKORDERDETAIL_REQUEST,workOrderDetail ,tostMsg} }
    function success(workOrderDetail,tostMsg) { return { type: userConstants.WORKORDERDETAIL_SUCCESS, workOrderDetail ,tostMsg} }
    function failure(error,tostMsg) { return { type: userConstants.WORKORDERDETAIL_FAILURE, error ,tostMsg} }
}