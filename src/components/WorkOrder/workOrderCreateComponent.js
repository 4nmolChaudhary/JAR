                                    ...
                                    <form>
                                       <Grid className="assent-info-form-part1">
                                          ...
                                          <Grid className="assets-buttons-part">
                                             <Button variant="contained" color="primary" className="assets-bottons txt-normal float_r"  style={{ "fontSize": "13px" }} onClick={this.createWorkOrder}>Create Work Order</Button>
                                             <Button variant="contained" color="primary" className="assets-bottons txt-normal float_r" style={{ "fontSize": "13px" }}  onClick={this.handleCancelClick}>Cancel</Button>   
                                         </Grid>
                                            ...
                                            <Grid className="col-md-10 col-sm-9 col-9">
                                               <Grid className="assets-info-devider">
                                                  ...
                                                  <TextField
                                                     ...
                                                     margin="normal"
                                                     fullWidth
                                                     value={_.get(this.state.inspectionDetail, ['asset', 'name'], '')}
                                                     id="name"
                                                     label="Name"
                                                     name="Name"
                                                     disabled="true"
                                            ...
                                            <Grid className="col-md-2 col-sm-3 col-3">
                                               <Grid className="assets-info-devider asset-info-img">
                                                  ...
                                                  {_.get(this.state.inspectionDetail, ['asset', 'asset_photo'], '')?
                                                     ...
                                                     <img alt="Sensaii" src={_.get(this.state.inspectionDetail, ['asset', 'asset_photo'], '')} style={{ "border": "1px solid #212128" }} className="MuiAvatar-img" />
                                                     </Grid>
                                                    :
                                                    <Grid className="user-profile">
                                                    <img alt="Sensaii" src={noImageAvailable} style={{"border": "1px solid #212128" }} className="MuiAvatar-img" />
                                                    </Grid>
                                                     } 
                                            ...
                                            <Grid className="col-md-6">
                                               <Grid className="assets-info-devider">
                                                  <TextField
                                                     ...
                                                     margin="normal"
                                                     fullWidth
                                                     value={_.get(this.state.inspectionDetail, ['asset', 'internal_asset_id'], '')}
                                                     id="asset"
                                                     label="Asset #"
                                                     name="asset"
                                                     disabled="true"
                                            ...
                                            <Grid className="col-md-6">
                                               <Grid className="assets-info-devider">
                                                  <TextField
                                                     ...
                                                     margin="normal"
                                                     fullWidth
                                                     value={_.get(this.state.inspectionDetail, ['operator_name'], '')}
                                                     id="inspection"
                                                     label="Operator"
                                                     name="inspection"
                                                     disabled="true"
